...
set C_modelArgList {
	{ input_q_0_V int 38 regular {array 96 { 1 1 } 1 1 }  }
	{ input_k_0_V int 38 regular {array 96 { 1 1 } 1 1 }  }
	...
	{ output_k_0_V int 38 regular {array 96 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ output_k_0_V_d0 sc_out sc_lv 38 signal 6 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	input_q_0_V { ap_memory {  { input_q_0_V_address0 mem_address 1 7 }  { input_q_0_V_ce0 mem_ce 1 1 }  { input_q_0_V_q0 mem_dout 0 38 }  { input_q_0_V_address1 MemPortADDR2 1 7 }  { input_q_0_V_ce1 MemPortCE2 1 1 }  { input_q_0_V_q1 MemPortDOUT2 0 38 } } }
	input_k_0_V { ap_memory {  { input_k_0_V_address0 mem_address 1 7 }  { input_k_0_V_ce0 mem_ce 1 1 }  { input_k_0_V_q0 mem_dout 0 38 }  { input_k_0_V_address1 MemPortADDR2 1 7 }  { input_k_0_V_ce1 MemPortCE2 1 1 }  { input_k_0_V_q1 MemPortDOUT2 0 38 } } }
	...
	output_k_0_V { ap_memory {  { output_k_0_V_address0 mem_address 1 7 }  { output_k_0_V_ce0 mem_ce 1 1 }  { output_k_0_V_we0 mem_we 1 1 }  { output_k_0_V_d0 mem_din 1 38 } } }
}
