...
// ==============================================================
#ifndef __dut_mul_50ns_50nstde__HH__
#define __dut_mul_50ns_50nstde__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_50ns_50nstde) {
    ...
    SC_CTOR(dut_mul_50ns_50nstde):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
