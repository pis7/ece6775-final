...
wire   [5:0] add_ln204_fu_162_p2;
reg   [5:0] add_ln204_reg_385;
wire   [0:0] icmp_ln201_fu_134_p2;
wire  signed [7:0] sext_ln203_fu_202_p1;
reg  signed [7:0] sext_ln203_reg_390;
wire   [7:0] sub_ln204_fu_214_p2;
reg   [7:0] sub_ln204_reg_395;
wire   [2:0] j_fu_226_p2;
reg   [2:0] j_reg_403;
wire    ap_CS_fsm_state3;
wire   [12:0] sub_ln204_1_fu_269_p2;
reg   [12:0] sub_ln204_1_reg_408;
wire   [0:0] icmp_ln202_fu_220_p2;
wire   [10:0] sub_ln203_3_fu_300_p2;
reg   [10:0] sub_ln203_3_reg_413;
wire   [0:0] icmp_ln204_fu_306_p2;
reg   [0:0] icmp_ln204_reg_418;
wire   [4:0] k_fu_318_p2;
reg   [4:0] k_reg_426;
wire    ap_CS_fsm_state4;
wire   [0:0] icmp_ln203_fu_312_p2;
...
wire   [12:0] zext_ln204_8_fu_332_p1;
wire   [12:0] add_ln204_2_fu_336_p2;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln202_fu_220_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln203_fu_312_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        j_0_reg_112 <= j_reg_403;
    end else if (((icmp_ln201_fu_134_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        j_0_reg_112 <= 3'd0;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    end else if (((icmp_ln202_fu_220_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        k_0_reg_123 <= 5'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln203_fu_312_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        add_ln203_4_reg_436 <= add_ln203_4_fu_346_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln201_fu_134_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        add_ln204_reg_385 <= add_ln204_fu_162_p2;
        sext_ln203_reg_390[7 : 1] <= sext_ln203_fu_202_p1[7 : 1];
        sub_ln204_reg_395[7 : 3] <= sub_ln204_fu_214_p2[7 : 3];
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln202_fu_220_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        icmp_ln204_reg_418 <= icmp_ln204_fu_306_p2;
        sub_ln203_3_reg_413[10 : 3] <= sub_ln203_3_fu_300_p2[10 : 3];
        sub_ln204_1_reg_408[12 : 3] <= sub_ln204_1_fu_269_p2[12 : 3];
    end
end
...
always @ (*) begin
    if ((((icmp_ln201_fu_134_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2)) | ((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln201_fu_134_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
assign add_ln203_4_fu_346_p2 = (sub_ln203_3_reg_413 + zext_ln204_7_fu_328_p1);

assign add_ln203_fu_275_p2 = ($signed(sext_ln203_reg_390) + $signed(zext_ln204_2_fu_232_p1));

assign add_ln204_1_fu_240_p2 = (add_ln204_reg_385 + zext_ln204_3_fu_236_p1);

assign add_ln204_2_fu_336_p2 = (sub_ln204_1_reg_408 + zext_ln204_8_fu_332_p1);

assign add_ln204_3_fu_351_p2 = (sub_ln204_reg_395 + zext_ln204_6_fu_324_p1);

assign add_ln204_fu_162_p2 = (zext_ln204_fu_146_p1 + zext_ln204_1_fu_158_p1);
...
assign cache_out_V_address0 = zext_ln203_10_fu_361_p1;

assign cache_out_V_d0 = ((icmp_ln204_reg_418[0:0] === 1'b1) ? update_0_V_q0 : sext_ln203_1_fu_365_p1);

assign i_fu_140_p2 = (i_0_reg_101 + 3'd1);

assign icmp_ln201_fu_134_p2 = ((i_0_reg_101 == 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln202_fu_220_p2 = ((j_0_reg_112 == 3'd6) ? 1'b1 : 1'b0);

assign icmp_ln203_fu_312_p2 = ((k_0_reg_123 == 5'd24) ? 1'b1 : 1'b0);

assign icmp_ln204_fu_306_p2 = ((j_0_reg_112 == 3'd5) ? 1'b1 : 1'b0);
...
assign sext_ln203_1_fu_365_p1 = $signed(v_cache_V_q0);

assign sext_ln203_fu_202_p1 = $signed(sub_ln203_fu_196_p2);

assign sext_ln204_fu_356_p1 = $signed(add_ln204_3_fu_351_p2);

assign sub_ln203_3_fu_300_p2 = (p_shl5_cast_fu_284_p3 - p_shl6_cast_fu_292_p3);

assign sub_ln203_fu_196_p2 = (zext_ln203_8_fu_180_p1 - zext_ln203_9_fu_192_p1);
...
assign update_0_V_address0 = sext_ln204_fu_356_p1;

assign v_cache_V_address0 = zext_ln204_9_fu_341_p1;
...
assign zext_ln204_7_fu_328_p1 = k_0_reg_123;

assign zext_ln204_8_fu_332_p1 = k_0_reg_123;

assign zext_ln204_9_fu_341_p1 = add_ln204_2_fu_336_p2;

assign zext_ln204_fu_146_p1 = i_0_reg_101;

always @ (posedge ap_clk) begin
    sext_ln203_reg_390[0] <= 1'b0;
    sub_ln204_reg_395[2:0] <= 3'b000;
    sub_ln204_1_reg_408[2:0] <= 3'b000;
    sub_ln203_3_reg_413[2:0] <= 3'b000;
end
