...
wire   [3:0] i_fu_192_p2;
reg   [3:0] i_reg_357;
wire    ap_CS_fsm_state2;
wire  signed [6:0] sub_ln203_fu_218_p2;
reg  signed [6:0] sub_ln203_reg_362;
...
reg   [5:0] input_0_V_addr_2_reg_405;
...
reg   [5:0] input_0_V_addr_3_reg_439;
...
wire   [4:0] tmp_48_fu_206_p3;
wire   [6:0] tmp_s_fu_198_p3;
wire   [6:0] zext_ln203_fu_214_p1;
wire   [6:0] zext_ln1494_fu_235_p1;
wire   [6:0] add_ln1494_fu_239_p2;
wire   [0:0] icmp_ln1494_fu_255_p2;
wire   [6:0] zext_ln1265_fu_281_p1;
wire   [6:0] add_ln1265_fu_285_p2;
wire   [6:0] zext_ln1265_1_fu_322_p1;
wire   [6:0] add_ln1265_1_fu_326_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln267_fu_186_p2 == 1'd0))) begin
        sub_ln203_reg_362[6 : 1] <= sub_ln203_fu_218_p2[6 : 1];
    end
end
...
assign i_fu_192_p2 = (i_0_reg_103 + 4'd1);

assign icmp_ln1494_fu_255_p2 = (($signed(input_0_V_q0) > $signed(p_Val2_33_0_reg_114)) ? 1'b1 : 1'b0);

assign icmp_ln267_fu_186_p2 = ((i_0_reg_103 == 4'd8) ? 1'b1 : 1'b0);
