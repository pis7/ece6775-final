...
// ==============================================================
#ifndef __dut_mul_50ns_50nsrcU__HH__
#define __dut_mul_50ns_50nsrcU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_50ns_50nsrcU) {
    ...
    SC_CTOR(dut_mul_50ns_50nsrcU):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
