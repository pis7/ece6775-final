...
// ==============================================================
#ifndef __dut_mul_48ns_50nsqcK__HH__
#define __dut_mul_48ns_50nsqcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_48ns_50nsqcK) {
    ...
    SC_CTOR(dut_mul_48ns_50nsqcK):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
