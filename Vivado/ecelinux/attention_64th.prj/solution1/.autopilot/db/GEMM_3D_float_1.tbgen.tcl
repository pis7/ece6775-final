...
set C_modelArgList {
	{ input_1_0_V int 38 regular {array 24 { 1 3 } 1 1 }  }
	{ input_2_V int 38 regular {array 144 { 1 3 } 1 1 }  }
	{ output_0_V int 38 regular {array 12 { 0 3 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	input_1_0_V { ap_memory {  { input_1_0_V_address0 mem_address 1 5 }  { input_1_0_V_ce0 mem_ce 1 1 }  { input_1_0_V_q0 mem_dout 0 38 } } }
	input_2_V { ap_memory {  { input_2_V_address0 mem_address 1 8 }  { input_2_V_ce0 mem_ce 1 1 }  { input_2_V_q0 mem_dout 0 38 } } }
	output_0_V { ap_memory {  { output_0_V_address0 mem_address 1 4 }  { output_0_V_ce0 mem_ce 1 1 }  { output_0_V_we0 mem_we 1 1 }  { output_0_V_d0 mem_din 1 38 } } }
}
