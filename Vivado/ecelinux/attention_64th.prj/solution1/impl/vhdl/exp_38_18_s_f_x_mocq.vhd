...
entity exp_38_18_s_f_x_mocq_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of exp_38_18_s_f_x_mocq_rom is 
...
entity exp_38_18_s_f_x_mocq is
    generic (
...
architecture arch of exp_38_18_s_f_x_mocq is
    component exp_38_18_s_f_x_mocq_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    exp_38_18_s_f_x_mocq_rom_U :  component exp_38_18_s_f_x_mocq_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
