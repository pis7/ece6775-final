...
entity attention_ln_weigibs_rom is 
    generic(
             DWIDTH     : integer := 40; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 16
...
architecture rtl of attention_ln_weigibs_rom is 
...
entity attention_ln_weigibs is
    generic (
...
architecture arch of attention_ln_weigibs is
    component attention_ln_weigibs_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    attention_ln_weigibs_rom_U :  component attention_ln_weigibs_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
