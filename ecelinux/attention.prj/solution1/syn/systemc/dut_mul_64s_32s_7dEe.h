...
// ==============================================================
#ifndef __dut_mul_64s_32s_7dEe__HH__
#define __dut_mul_64s_32s_7dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_64s_32s_7dEe) {
    ...
    SC_CTOR(dut_mul_64s_32s_7dEe):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
