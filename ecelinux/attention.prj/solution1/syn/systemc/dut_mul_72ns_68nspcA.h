...
// ==============================================================
#ifndef __dut_mul_72ns_68nspcA__HH__
#define __dut_mul_72ns_68nspcA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_72ns_68nspcA) {
    ...
    SC_CTOR(dut_mul_72ns_68nspcA):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
