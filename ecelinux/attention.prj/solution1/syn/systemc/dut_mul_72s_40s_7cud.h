...
// ==============================================================
#ifndef __dut_mul_72s_40s_7cud__HH__
#define __dut_mul_72s_40s_7cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_72s_40s_7cud) {
    ...
    SC_CTOR(dut_mul_72s_40s_7cud):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
