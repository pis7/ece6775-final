...
// ==============================================================
#ifndef __dut_udiv_40ns_40nfYi__HH__
#define __dut_udiv_40ns_40nfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_udiv_40ns_40nfYi) {
    ...
    SC_CTOR(dut_udiv_40ns_40nfYi):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
