...
// ==============================================================
#ifndef __dut_udiv_40ns_40ndEe__HH__
#define __dut_udiv_40ns_40ndEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_udiv_40ns_40ndEe) {
    ...
    SC_CTOR(dut_udiv_40ns_40ndEe):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
