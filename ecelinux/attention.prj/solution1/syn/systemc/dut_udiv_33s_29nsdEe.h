...
// ==============================================================
#ifndef __dut_udiv_33s_29nsdEe__HH__
#define __dut_udiv_33s_29nsdEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_udiv_33s_29nsdEe) {
    ...
    SC_CTOR(dut_udiv_33s_29nsdEe):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
