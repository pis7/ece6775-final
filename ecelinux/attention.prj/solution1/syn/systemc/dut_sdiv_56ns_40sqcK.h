...
// ==============================================================
#ifndef __dut_sdiv_56ns_40sqcK__HH__
#define __dut_sdiv_56ns_40sqcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_sdiv_56ns_40sqcK) {
    ...
    SC_CTOR(dut_sdiv_56ns_40sqcK):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
