...
// ==============================================================
#ifndef __dut_sdiv_56ns_40shbi__HH__
#define __dut_sdiv_56ns_40shbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_sdiv_56ns_40shbi) {
    ...
    SC_CTOR(dut_sdiv_56ns_40shbi):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
