...
// ==============================================================
#ifndef __dut_udiv_51s_31nseOg__HH__
#define __dut_udiv_51s_31nseOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_udiv_51s_31nseOg) {
    ...
    ACMP_udiv_seq<ID, 55, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_udiv_seq_U;

    SC_CTOR(dut_udiv_51s_31nseOg):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
