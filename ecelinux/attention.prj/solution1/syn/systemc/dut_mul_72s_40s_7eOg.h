...
// ==============================================================
#ifndef __dut_mul_72s_40s_7eOg__HH__
#define __dut_mul_72s_40s_7eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_72s_40s_7eOg) {
    ...
    SC_CTOR(dut_mul_72s_40s_7eOg):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
