...
// ==============================================================
#ifndef __dut_fpext_32ns_64bkb__HH__
#define __dut_fpext_32ns_64bkb__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_fpext_32ns_64bkb) {
    ...
    SC_CTOR(dut_fpext_32ns_64bkb):  ACMP_fpext_U ("ACMP_fpext_U") {
