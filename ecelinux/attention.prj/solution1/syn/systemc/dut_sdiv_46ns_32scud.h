...
// ==============================================================
#ifndef __dut_sdiv_46ns_32scud__HH__
#define __dut_sdiv_46ns_32scud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_sdiv_46ns_32scud) {
    ...
    ACMP_sdiv_seq<ID, 50, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_sdiv_seq_U;

    SC_CTOR(dut_sdiv_46ns_32scud):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
