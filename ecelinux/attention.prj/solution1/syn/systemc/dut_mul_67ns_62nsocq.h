...
// ==============================================================
#ifndef __dut_mul_67ns_62nsocq__HH__
#define __dut_mul_67ns_62nsocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_67ns_62nsocq) {
    ...
    SC_CTOR(dut_mul_67ns_62nsocq):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
