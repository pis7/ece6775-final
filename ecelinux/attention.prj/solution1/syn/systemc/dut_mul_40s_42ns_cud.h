...
// ==============================================================
#ifndef __dut_mul_40s_42ns_cud__HH__
#define __dut_mul_40s_42ns_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_40s_42ns_cud) {
    ...
    SC_CTOR(dut_mul_40s_42ns_cud):  ACMP_mul_su_U ("ACMP_mul_su_U") {
