...
set C_modelArgList {
	{ input_0_V int 8 regular {array 384 { 1 3 } 1 1 }  }
	{ output_0_V int 40 regular {array 384 { 2 3 } 1 1 }  }
	{ scales_0_V_read int 40 regular  }
	{ packed_weights int 8 regular {array 36864 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ output_0_V_address0 sc_out sc_lv 9 signal 1 } 
	...
	{ packed_weights_address0 sc_out sc_lv 16 signal 3 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dut_sdiv_72ns_61sfYi_U15", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "251137", "Max" : "582913"}
	, {"Name" : "Interval", "Min" : "251137", "Max" : "582913"}
]}
...
set Spec2ImplPortList { 
	input_0_V { ap_memory {  { input_0_V_address0 mem_address 1 9 }  { input_0_V_ce0 mem_ce 1 1 }  { input_0_V_q0 mem_dout 0 8 } } }
	...
	packed_weights { ap_memory {  { packed_weights_address0 mem_address 1 16 }  { packed_weights_ce0 mem_ce 1 1 }  { packed_weights_q0 mem_dout 0 8 } } }
