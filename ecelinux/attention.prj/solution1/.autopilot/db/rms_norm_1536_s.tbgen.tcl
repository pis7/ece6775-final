set moduleName rms_norm_1536_s
set isTopModule 0
...
set C_modelName {rms_norm<1536>}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_0_V int 40 regular {array 1536 { 2 3 } 1 1 }  }
	{ weight float 32 regular {array 1536 { 1 3 } 1 1 }  }
}
...
set portList { 
	...
	{ weight_address0 sc_out sc_lv 11 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "weight_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "weight", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_sqrt_fixed_42_26_s_fu_161", "Parent" : "0",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dut_fpext_32ns_64bkb_U2", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dut_mul_40s_42ns_cud_U3", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dut_udiv_33s_29nsdEe_U4", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dut_mul_72s_40s_7eOg_U5", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "24636", "Max" : "24636"}
	, {"Name" : "Interval", "Min" : "24636", "Max" : "24636"}
]}
...
set Spec2ImplPortList { 
	input_0_V { ap_memory {  { input_0_V_address0 mem_address 1 11 }  { input_0_V_ce0 mem_ce 1 1 }  { input_0_V_we0 mem_we 1 1 }  { input_0_V_d0 mem_din 1 40 }  { input_0_V_q0 mem_dout 0 40 } } }
	weight { ap_memory {  { weight_address0 mem_address 1 11 }  { weight_ce0 mem_ce 1 1 }  { weight_q0 mem_dout 0 32 } } }
}
