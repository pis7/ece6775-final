...
set C_modelArgList {
	{ input_0_V int 32 regular {array 12 { 1 3 } 1 1 }  }
	{ input_1_V int 32 regular {array 12 { 1 3 } 1 1 }  }
	{ input_2_V int 32 regular {array 12 { 1 3 } 1 1 }  }
	{ input_3_V int 32 regular {array 12 { 1 3 } 1 1 }  }
	{ output_0_V int 32 regular {array 16 { 0 0 } 0 1 }  }
	{ output_1_V int 32 regular {array 16 { 0 0 } 0 1 }  }
	{ output_2_V int 32 regular {array 16 { 0 0 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_0_V", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "output_0_V", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "output_1_V", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "output_2_V", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ output_0_V_d0 sc_out sc_lv 32 signal 4 } 
	...
	{ output_0_V_d1 sc_out sc_lv 32 signal 4 } 
	...
	{ output_1_V_d0 sc_out sc_lv 32 signal 5 } 
	...
	{ output_1_V_d1 sc_out sc_lv 32 signal 5 } 
	...
	{ output_2_V_d0 sc_out sc_lv 32 signal 6 } 
	...
	{ output_2_V_d1 sc_out sc_lv 32 signal 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "output_1_V_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "output_1_V", "role": "d1" }} , 
 	...
 	{ "name": "output_2_V_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "output_2_V", "role": "d1" }}  ]}
...
set Spec2ImplPortList { 
	input_0_V { ap_memory {  { input_0_V_address0 mem_address 1 4 }  { input_0_V_ce0 mem_ce 1 1 }  { input_0_V_q0 mem_dout 0 32 } } }
	input_1_V { ap_memory {  { input_1_V_address0 mem_address 1 4 }  { input_1_V_ce0 mem_ce 1 1 }  { input_1_V_q0 mem_dout 0 32 } } }
	input_2_V { ap_memory {  { input_2_V_address0 mem_address 1 4 }  { input_2_V_ce0 mem_ce 1 1 }  { input_2_V_q0 mem_dout 0 32 } } }
	input_3_V { ap_memory {  { input_3_V_address0 mem_address 1 4 }  { input_3_V_ce0 mem_ce 1 1 }  { input_3_V_q0 mem_dout 0 32 } } }
	output_0_V { ap_memory {  { output_0_V_address0 mem_address 1 4 }  { output_0_V_ce0 mem_ce 1 1 }  { output_0_V_we0 mem_we 1 1 }  { output_0_V_d0 mem_din 1 32 }  { output_0_V_address1 MemPortADDR2 1 4 }  { output_0_V_ce1 MemPortCE2 1 1 }  { output_0_V_we1 MemPortWE2 1 1 }  { output_0_V_d1 MemPortDIN2 1 32 } } }
	output_1_V { ap_memory {  { output_1_V_address0 mem_address 1 4 }  { output_1_V_ce0 mem_ce 1 1 }  { output_1_V_we0 mem_we 1 1 }  { output_1_V_d0 mem_din 1 32 }  { output_1_V_address1 MemPortADDR2 1 4 }  { output_1_V_ce1 MemPortCE2 1 1 }  { output_1_V_we1 MemPortWE2 1 1 }  { output_1_V_d1 MemPortDIN2 1 32 } } }
	output_2_V { ap_memory {  { output_2_V_address0 mem_address 1 4 }  { output_2_V_ce0 mem_ce 1 1 }  { output_2_V_we0 mem_we 1 1 }  { output_2_V_d0 mem_din 1 32 }  { output_2_V_address1 MemPortADDR2 1 4 }  { output_2_V_ce1 MemPortCE2 1 1 }  { output_2_V_we1 MemPortWE2 1 1 }  { output_2_V_d1 MemPortDIN2 1 32 } } }
}
