...
`define AUTOTB_TVIN_strm_in_V_V  "./c.dut.autotvin_strm_in_V_V.dat"
`define AUTOTB_TVIN_strm_out_V_V  "./c.dut.autotvin_strm_out_V_V.dat"
`define AUTOTB_TVIN_strm_in_V_V_out_wrapc  "./rtl.dut.autotvin_strm_in_V_V.dat"
`define AUTOTB_TVIN_strm_out_V_V_out_wrapc  "./rtl.dut.autotvin_strm_out_V_V.dat"
`define AUTOTB_TVOUT_strm_out_V_V  "./c.dut.autotvout_strm_out_V_V.dat"
`define AUTOTB_TVOUT_strm_out_V_V_out_wrapc  "./impl_rtl.dut.autotvout_strm_out_V_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 36163083;
parameter LENGTH_strm_in_V_V = 1536;
parameter LENGTH_strm_out_V_V = 1536;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.dut.autotvout_strm_out_V_V.dat", "r");
    fp2 = $fopen("./impl_rtl.dut.autotvout_strm_out_V_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.dut.autotvout_strm_out_V_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.dut.autotvout_strm_out_V_V.dat\"!");
    else begin
        $display("Comparing rtl.dut.autotvout_strm_out_V_V.dat with impl_rtl.dut.autotvout_strm_out_V_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
initial begin : proc_gen_strm_in_V_V_internal_ready
    ...
    `define STREAM_SIZE_IN_strm_in_V_V "./stream_size_in_strm_in_V_V.dat"
