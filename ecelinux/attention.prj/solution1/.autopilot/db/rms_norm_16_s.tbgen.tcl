...
set C_modelArgList {
	{ input_0_V int 40 regular {array 16 { 1 0 } 1 1 }  }
	{ weight_V int 40 regular {array 16 { 1 3 } 1 1 }  }
}
...
set portList { 
	...
	{ input_0_V_d1 sc_out sc_lv 40 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input_0_V_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":40, "type": "signal", "bundle":{"name": "input_0_V", "role": "d1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_sqrt_fixed_42_26_s_fu_139", "Parent" : "0",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dut_udiv_33s_29nsbkb_U2", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dut_mul_72s_40s_7cud_U3", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	input_0_V { ap_memory {  { input_0_V_address0 mem_address 1 4 }  { input_0_V_ce0 mem_ce 1 1 }  { input_0_V_q0 mem_dout 0 40 }  { input_0_V_address1 MemPortADDR2 1 4 }  { input_0_V_ce1 MemPortCE2 1 1 }  { input_0_V_we1 MemPortWE2 1 1 }  { input_0_V_d1 MemPortDIN2 1 40 } } }
	weight_V { ap_memory {  { weight_V_address0 mem_address 1 4 }  { weight_V_ce0 mem_ce 1 1 }  { weight_V_q0 mem_dout 0 40 } } }
}
