...
set C_modelArgList {
	...
	{ output_q_0_V int 40 regular {array 384 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ output_q_0_V_address0 sc_out sc_lv 9 signal 2 } 
	...
	{ output_k_0_V_address0 sc_out sc_lv 9 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "output_q_0_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "output_q_0_V", "role": "address0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2146", "Max" : "2146"}
	, {"Name" : "Interval", "Min" : "2146", "Max" : "2146"}
]}
...
set Spec2ImplPortList { 
	...
	output_q_0_V { ap_memory {  { output_q_0_V_address0 mem_address 1 9 }  { output_q_0_V_ce0 mem_ce 1 1 }  { output_q_0_V_we0 mem_we 1 1 }  { output_q_0_V_d0 mem_din 1 40 } } }
