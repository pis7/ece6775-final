...
extern void dut (
hls::stream<ap_fixed<32, 10, (ap_q_mode) 5, (ap_o_mode)3, 0> > (&strm_in),
hls::stream<ap_fixed<32, 10, (ap_q_mode) 5, (ap_o_mode)3, 0> > (&strm_out));
...
hls::stream<ap_fixed<32, 10, (ap_q_mode) 5, (ap_o_mode)3, 0> > (&strm_out))
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		std::vector<ap_fixed<32, 10, (ap_q_mode) 5, (ap_o_mode)3, 0> > aesl_tmp_9;
		int aesl_tmp_10;
		int aesl_tmp_11 = 0;
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			if (aesl_tmp_10 > 0 && aesl_tmp_9.size() < aesl_tmp_10)
			{
				...
				{
					ap_fixed<32, 10, (ap_q_mode) 5, (ap_o_mode)3, 0> tmp;
	...
	else
	{
		...
		std::vector<ap_fixed<32, 10, (ap_q_mode) 5, (ap_o_mode)3, 0> > aesl_tmp_6;
		int aesl_tmp_7 = 0;
		while (!strm_in.empty())
		{
