...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "dut.autotvin.dat"
	set constFileTvOut       "dut.autotvout.dat"
	set constFileHdlTvIn     "dut.autohdltvin.dat"
	set constFileHdlTvOut    "dut.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
