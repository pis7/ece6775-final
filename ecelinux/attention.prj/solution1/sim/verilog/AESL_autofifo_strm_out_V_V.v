...
module AESL_autofifo_strm_out_V_V (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.dut.autotvin_strm_out_V_V.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.dut.autotvout_strm_out_V_V.dat";

//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 12;
parameter DEPTH = 32'd 1536;
