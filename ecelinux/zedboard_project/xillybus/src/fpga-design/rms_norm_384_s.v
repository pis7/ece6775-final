...
reg   [31:0] tmp_72_reg_340;
wire   [31:0] select_ln1148_1_fu_242_p3;
reg   [31:0] select_ln1148_1_reg_346;
...
wire   [8:0] i_1_fu_268_p2;
reg   [8:0] i_1_reg_369;
wire    ap_CS_fsm_state64;
wire   [0:0] icmp_ln93_fu_262_p2;
reg   [8:0] input_0_V_addr_4_reg_379;
...
reg   [8:0] i_0_reg_105;
reg   [8:0] i1_0_reg_116;
wire    ap_CS_fsm_state72;
wire    ap_CS_fsm_state8;
wire   [63:0] zext_ln89_fu_148_p1;
wire   [63:0] zext_ln94_fu_274_p1;
...
wire   [31:0] tmp_71_fu_219_p4;
wire   [31:0] select_ln1148_fu_229_p3;
wire   [31:0] sub_ln1227_fu_236_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state64) & (icmp_ln93_fu_262_p2 == 1'd0))) begin
        input_0_V_addr_4_reg_379 <= zext_ln94_fu_274_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        tmp_72_reg_340 <= {{grp_fu_157_p2[80:49]}};
    end
end
...
always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | ((1'b1 == ap_CS_fsm_state64) & (icmp_ln93_fu_262_p2 == 1'd1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state64) & (icmp_ln93_fu_262_p2 == 1'd1))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state72) | (1'b1 == ap_CS_fsm_state65))) begin
        ...
        input_0_V_address0 = zext_ln89_fu_148_p1;
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln88_fu_136_p2 == 1'd1))) begin
...
assign i_1_fu_268_p2 = (i1_0_reg_116 + 9'd1);

assign i_fu_142_p2 = (i_0_reg_105 + 9'd1);

assign icmp_ln88_fu_136_p2 = ((i_0_reg_105 == 9'd384) ? 1'b1 : 1'b0);

assign icmp_ln93_fu_262_p2 = ((i1_0_reg_116 == 9'd384) ? 1'b1 : 1'b0);
...
assign sub_ln1227_fu_236_p2 = (32'd0 - select_ln1148_fu_229_p3);

assign tmp_71_fu_219_p4 = {{sub_ln1148_fu_206_p2[80:49]}};

assign tmp_fu_211_p3 = p_Val2_s_reg_93[32'd39];

assign weight_V_address0 = zext_ln94_fu_274_p1;

assign zext_ln1118_fu_258_p1 = grp_fu_252_p2;

assign zext_ln89_fu_148_p1 = i_0_reg_105;

assign zext_ln94_fu_274_p1 = i1_0_reg_116;

always @ (posedge ap_clk) begin
    zext_ln1118_reg_361[71:33] <= 39'b000000000000000000000000000000000000000;
end

endmodule //rms_norm_384_s
