...
reg   [35:0] tmp_72_reg_340;
wire   [35:0] select_ln1148_1_fu_242_p3;
reg   [35:0] select_ln1148_1_reg_346;
...
reg   [4:0] input_0_V_addr_4_reg_379;
...
wire   [35:0] tmp_71_fu_219_p4;
wire   [35:0] select_ln1148_fu_229_p3;
wire   [35:0] sub_ln1227_fu_236_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        tmp_72_reg_340 <= {{grp_fu_157_p2[80:45]}};
    end
end
...
assign i_1_fu_268_p2 = (i1_0_reg_116 + 5'd1);

assign i_fu_142_p2 = (i_0_reg_105 + 5'd1);

assign icmp_ln46_fu_136_p2 = ((i_0_reg_105 == 5'd24) ? 1'b1 : 1'b0);

assign icmp_ln51_fu_262_p2 = ((i1_0_reg_116 == 5'd24) ? 1'b1 : 1'b0);
...
assign sub_ln1227_fu_236_p2 = (36'd0 - select_ln1148_fu_229_p3);

assign tmp_71_fu_219_p4 = {{sub_ln1148_fu_206_p2[80:45]}};
