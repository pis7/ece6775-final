...
# set_directive_array_reshape -type complete -dim 1 attention q_weights
# set_directive_array_reshape -type complete -dim 1 attention k_weights
# set_directive_array_reshape -type complete -dim 1 attention v_weights
# set_directive_array_reshape -type complete -dim 1 attention o_weights
# set_directive_array_partition -type block -factor 2 -dim 2 attention quantized_hidden_states
# set_directive_array_partition -type block -factor 2 -dim 2 attention quantized_final_output
