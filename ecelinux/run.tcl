...
# array directives
# set_directive_array_partition -type complete -dim 2 attention hidden_states
...
set_directive_array_partition -type complete -dim 1 attention q_weights
set_directive_array_partition -type complete -dim 1 attention k_weights
set_directive_array_partition -type complete -dim 1 attention v_weights
set_directive_array_partition -type complete -dim 1 attention o_weights
set_directive_array_partition -type complete -dim 2 attention quantized_hidden_states
set_directive_array_partition -type complete -dim 2 attention quantized_final_output
...
# set_directive_array_partition -type complete -dim 2 attention attn_output_2D
...
set_directive_pipeline -II 2 linear_forward_no_mul/LINEAR_FORWARD_NO_MUL_LOOP_2
