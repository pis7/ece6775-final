...
set C_modelArgList {
	...
	{ weight_V int 40 regular {array 24 { 1 3 } 1 1 }  }
}
...
set Spec2ImplPortList { 
	...
	weight_V { ap_memory {  { weight_V_address0 mem_address 1 5 }  { weight_V_ce0 mem_ce 1 1 }  { weight_V_q0 mem_dout 0 40 } } }
}
