...
set C_modelArgList {
	{ input_q_0_V int 40 regular {array 24 { 1 1 } 1 1 }  }
	{ input_k_0_V int 40 regular {array 24 { 1 1 } 1 1 }  }
	{ output_q_0_V int 40 regular {array 24 { 0 3 } 0 1 }  }
	{ output_k_0_V int 40 regular {array 24 { 0 3 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	input_q_0_V { ap_memory {  { input_q_0_V_address0 mem_address 1 5 }  { input_q_0_V_ce0 mem_ce 1 1 }  { input_q_0_V_q0 mem_dout 0 40 }  { input_q_0_V_address1 MemPortADDR2 1 5 }  { input_q_0_V_ce1 MemPortCE2 1 1 }  { input_q_0_V_q1 MemPortDOUT2 0 40 } } }
	input_k_0_V { ap_memory {  { input_k_0_V_address0 mem_address 1 5 }  { input_k_0_V_ce0 mem_ce 1 1 }  { input_k_0_V_q0 mem_dout 0 40 }  { input_k_0_V_address1 MemPortADDR2 1 5 }  { input_k_0_V_ce1 MemPortCE2 1 1 }  { input_k_0_V_q1 MemPortDOUT2 0 40 } } }
	output_q_0_V { ap_memory {  { output_q_0_V_address0 mem_address 1 5 }  { output_q_0_V_ce0 mem_ce 1 1 }  { output_q_0_V_we0 mem_we 1 1 }  { output_q_0_V_d0 mem_din 1 40 } } }
	output_k_0_V { ap_memory {  { output_k_0_V_address0 mem_address 1 5 }  { output_k_0_V_ce0 mem_ce 1 1 }  { output_k_0_V_we0 mem_we 1 1 }  { output_k_0_V_d0 mem_din 1 40 } } }
}
