...
set C_modelArgList {
	{ cache_out_V int 40 regular {array 144 { 0 3 } 0 1 }  }
	{ update_0_V int 40 regular {array 24 { 1 3 } 1 1 }  }
}
...
set Spec2ImplPortList { 
	cache_out_V { ap_memory {  { cache_out_V_address0 mem_address 1 8 }  { cache_out_V_ce0 mem_ce 1 1 }  { cache_out_V_we0 mem_we 1 1 }  { cache_out_V_d0 mem_din 1 40 } } }
	update_0_V { ap_memory {  { update_0_V_address0 mem_address 1 5 }  { update_0_V_ce0 mem_ce 1 1 }  { update_0_V_q0 mem_dout 0 40 } } }
}
