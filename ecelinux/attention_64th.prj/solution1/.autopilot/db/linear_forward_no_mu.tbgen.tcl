...
set C_modelArgList {
	...
	{ output_0_V int 40 regular {array 24 { 2 0 } 1 1 }  }
...
set Spec2ImplPortList { 
	...
	output_0_V { ap_memory {  { output_0_V_address0 mem_address 1 5 }  { output_0_V_ce0 mem_ce 1 1 }  { output_0_V_we0 mem_we 1 1 }  { output_0_V_d0 mem_din 1 40 }  { output_0_V_q0 mem_dout 0 40 }  { output_0_V_address1 MemPortADDR2 1 5 }  { output_0_V_ce1 MemPortCE2 1 1 }  { output_0_V_we1 MemPortWE2 1 1 }  { output_0_V_d1 MemPortDIN2 1 40 } } }
