...
set C_modelArgList {
	{ input_0_V int 8 regular {array 24 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ output_0_V_address0 sc_out sc_lv 5 signal 1 } 
	...
	{ packed_weights_address0 sc_out sc_lv 8 signal 3 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2737", "Max" : "4033"}
	, {"Name" : "Interval", "Min" : "2737", "Max" : "4033"}
]}
...
set Spec2ImplPortList { 
	input_0_V { ap_memory {  { input_0_V_address0 mem_address 1 5 }  { input_0_V_ce0 mem_ce 1 1 }  { input_0_V_q0 mem_dout 0 8 } } }
