...
wire   [2:0] add_ln204_fu_354_p2;
reg   [2:0] add_ln204_reg_572;
...
wire   [3:0] add_ln216_fu_454_p2;
reg   [3:0] add_ln216_reg_625;
...
wire   [55:0] mul_ln1118_1_fu_501_p2;
reg   [55:0] mul_ln1118_1_reg_701;
wire   [55:0] mul_ln1118_2_fu_510_p2;
reg   [55:0] mul_ln1118_2_reg_706;
wire   [55:0] mul_ln1118_3_fu_519_p2;
reg   [55:0] mul_ln1118_3_reg_711;
...
wire   [3:0] tmp_73_fu_326_p3;
wire   [5:0] tmp_72_fu_318_p3;
wire   [5:0] zext_ln1265_fu_334_p1;
wire   [5:0] zext_ln203_fu_360_p1;
wire   [5:0] add_ln203_fu_364_p2;
wire   [3:0] zext_ln204_fu_344_p1;
wire   [3:0] add_ln205_fu_375_p2;
wire   [5:0] zext_ln1265_3_fu_381_p1;
wire   [5:0] add_ln1265_fu_385_p2;
wire   [3:0] tmp_75_fu_430_p3;
wire   [5:0] tmp_74_fu_422_p3;
wire   [5:0] zext_ln1116_fu_438_p1;
wire   [5:0] zext_ln1116_2_fu_466_p1;
wire   [5:0] add_ln1116_fu_470_p2;
wire  signed [16:0] mul_ln1118_fu_489_p0;
wire  signed [55:0] sext_ln1118_2_fu_486_p1;
wire  signed [39:0] mul_ln1118_fu_489_p1;
wire  signed [16:0] mul_ln1118_1_fu_501_p0;
wire  signed [55:0] sext_ln1118_4_fu_498_p1;
wire  signed [39:0] mul_ln1118_1_fu_501_p1;
wire  signed [16:0] mul_ln1118_2_fu_510_p0;
wire  signed [39:0] mul_ln1118_2_fu_510_p1;
wire  signed [16:0] mul_ln1118_3_fu_519_p0;
wire  signed [39:0] mul_ln1118_3_fu_519_p1;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln202_fu_306_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        i14_0_reg_284 <= 2'd0;
    end else if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln216_fu_448_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        i_0_reg_262 <= 2'd0;
    end else if (((icmp_ln204_fu_348_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((icmp_ln214_fu_410_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln216_fu_448_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state6))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln214_fu_410_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | ((1'b1 == ap_CS_fsm_state5) & (icmp_ln214_fu_410_p2 == 1'd1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) & (icmp_ln214_fu_410_p2 == 1'd1))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((icmp_ln204_fu_348_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
        ...
        ap_ST_fsm_state6 : begin
            if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln216_fu_448_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end else begin
...
assign add_ln1192_1_fu_540_p2 = (mul_ln1118_2_reg_706 + mul_ln1118_3_reg_711);

assign add_ln1192_fu_525_p2 = (mul_ln1118_reg_696 + mul_ln1118_1_reg_701);
...
assign add_ln204_fu_354_p2 = (k_0_0_reg_273 + 3'd1);

assign add_ln205_fu_375_p2 = (zext_ln204_fu_344_p1 + 4'd6);

assign add_ln216_fu_454_p2 = (k16_0_0_reg_295 + 4'd1);
...
assign icmp_ln202_fu_306_p2 = ((i_0_reg_262 == 2'd2) ? 1'b1 : 1'b0);

assign icmp_ln204_fu_348_p2 = ((k_0_0_reg_273 == 3'd6) ? 1'b1 : 1'b0);

assign icmp_ln214_fu_410_p2 = ((i14_0_reg_284 == 2'd2) ? 1'b1 : 1'b0);

assign icmp_ln216_fu_448_p2 = ((k16_0_0_reg_295 == 4'd12) ? 1'b1 : 1'b0);

assign input_k_0_V_address1 = sext_ln203_fu_369_p1;

assign input_q_0_V_address1 = sext_ln203_fu_369_p1;

assign mul_ln1118_1_fu_501_p0 = sext_ln1118_4_fu_498_p1;

assign mul_ln1118_1_fu_501_p1 = rotated_q_0_V_load_reg_681;

assign mul_ln1118_1_fu_501_p2 = ($signed(mul_ln1118_1_fu_501_p0) * $signed(mul_ln1118_1_fu_501_p1));

assign mul_ln1118_2_fu_510_p0 = sext_ln1118_2_fu_486_p1;

assign mul_ln1118_2_fu_510_p1 = input_k_0_V_load_2_reg_686;

assign mul_ln1118_2_fu_510_p2 = ($signed(mul_ln1118_2_fu_510_p0) * $signed(mul_ln1118_2_fu_510_p1));

assign mul_ln1118_3_fu_519_p0 = sext_ln1118_4_fu_498_p1;

assign mul_ln1118_3_fu_519_p1 = rotated_k_0_V_load_reg_691;

assign mul_ln1118_3_fu_519_p2 = ($signed(mul_ln1118_3_fu_519_p0) * $signed(mul_ln1118_3_fu_519_p1));

assign mul_ln1118_fu_489_p0 = sext_ln1118_2_fu_486_p1;

assign mul_ln1118_fu_489_p1 = input_q_0_V_load_2_reg_671;
...
assign sext_ln1118_2_fu_486_p1 = $signed(cos_tab_V_5_load_reg_666);

assign sext_ln1118_4_fu_498_p1 = $signed(sin_tab_V_5_load_reg_676);
...
assign tmp_72_fu_318_p3 = {{i_0_reg_262}, {4'd0}};

assign tmp_73_fu_326_p3 = {{i_0_reg_262}, {2'd0}};

assign tmp_74_fu_422_p3 = {{i14_0_reg_284}, {4'd0}};

assign tmp_75_fu_430_p3 = {{i14_0_reg_284}, {2'd0}};
...
assign zext_ln204_fu_344_p1 = k_0_0_reg_273;

assign zext_ln217_fu_460_p1 = k16_0_0_reg_295;
