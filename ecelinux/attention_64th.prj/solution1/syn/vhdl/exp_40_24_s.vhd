...
architecture behav of exp_40_24_s is 
    ...
    signal p_Result_s_95_fu_355_p3 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    dut_mul_50ns_47nspcA_U48 : component dut_mul_50ns_47nspcA
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 50,
    ...
    dut_mul_50ns_50nsqcK_U49 : component dut_mul_50ns_50nsqcK
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 50,
    ...
    p_Result_s_95_fu_355_p3 <= zext_ln727_fu_181_p1(30 downto 30);
    ...
    xor_ln278_10_fu_363_p2 <= (tmp_fu_207_p3 xor p_Result_s_95_fu_355_p3);
