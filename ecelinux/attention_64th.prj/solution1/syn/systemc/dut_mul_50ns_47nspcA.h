...
// ==============================================================
#ifndef __dut_mul_50ns_47nspcA__HH__
#define __dut_mul_50ns_47nspcA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_50ns_47nspcA) {
    ...
    SC_CTOR(dut_mul_50ns_47nspcA):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
