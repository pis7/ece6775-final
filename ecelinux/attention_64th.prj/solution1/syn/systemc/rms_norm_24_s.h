...
#ifndef _rms_norm_24_s_HH_
#define _rms_norm_24_s_HH_
...
struct rms_norm_24_s : public sc_module {
    ...
    sc_out< sc_lv<5> > weight_V_address0;
    ...
    // Module declarations
    rms_norm_24_s(sc_module_name name);
    SC_HAS_PROCESS(rms_norm_24_s);
    ...
    sc_signal< sc_lv<36> > tmp_72_reg_340;
    sc_signal< sc_lv<36> > select_ln1148_1_fu_242_p3;
    sc_signal< sc_lv<36> > select_ln1148_1_reg_346;
    ...
    sc_signal< sc_lv<5> > i1_0_reg_116;
    ...
    sc_signal< sc_lv<36> > tmp_71_fu_219_p4;
    sc_signal< sc_lv<36> > select_ln1148_fu_229_p3;
    sc_signal< sc_lv<36> > sub_ln1227_fu_236_p2;
