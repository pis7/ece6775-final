...
// ==============================================================
#ifndef __attention_ln_weigtde_H__
#define __attention_ln_weigtde_H__
...
struct attention_ln_weigtde_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(attention_ln_weigtde_ram) {
...
SC_MODULE(attention_ln_weigtde) {
...
attention_ln_weigtde_ram* meminst;


SC_CTOR(attention_ln_weigtde) {
meminst = new attention_ln_weigtde_ram("attention_ln_weigtde_ram");
