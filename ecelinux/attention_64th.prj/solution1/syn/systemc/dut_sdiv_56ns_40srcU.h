...
// ==============================================================
#ifndef __dut_sdiv_56ns_40srcU__HH__
#define __dut_sdiv_56ns_40srcU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_sdiv_56ns_40srcU) {
    ...
    SC_CTOR(dut_sdiv_56ns_40srcU):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
