...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state64) and (icmp_ln92_fu_262_p2 = ap_const_lv1_0))) then
                input_0_V_addr_4_reg_379 <= zext_ln93_fu_274_p1(5 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    icmp_ln87_fu_136_p2 <= "1" when (i_0_reg_105 = ap_const_lv5_18) else "0";
    icmp_ln92_fu_262_p2 <= "1" when (i1_0_reg_116 = ap_const_lv5_18) else "0";
    ...
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state72) or (ap_const_logic_1 = ap_CS_fsm_state65))) then 
            ...
            input_0_V_address0 <= zext_ln88_fu_148_p1(5 - 1 downto 0);
        else 
    ...
    weight_V_address0 <= zext_ln93_fu_274_p1(5 - 1 downto 0);
