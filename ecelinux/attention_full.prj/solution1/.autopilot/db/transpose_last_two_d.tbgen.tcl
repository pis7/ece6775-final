...
set C_modelArgList {
	...
	{ output_V int 40 regular {array 9216 { 0 3 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	...
	output_V { ap_memory {  { output_V_address0 mem_address 1 14 }  { output_V_ce0 mem_ce 1 1 }  { output_V_we0 mem_we 1 1 }  { output_V_d0 mem_din 1 40 } } }
}
