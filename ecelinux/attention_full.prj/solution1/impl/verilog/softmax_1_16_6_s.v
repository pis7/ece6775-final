...
wire  signed [7:0] sub_ln203_fu_207_p2;
reg  signed [7:0] sub_ln203_reg_352;
...
reg   [6:0] input_0_V_addr_2_reg_395;
...
reg   [6:0] input_0_V_addr_3_reg_423;
...
wire   [5:0] tmp_53_fu_195_p3;
wire   [7:0] tmp_s_fu_187_p3;
wire   [7:0] zext_ln203_fu_203_p1;
wire   [7:0] zext_ln1494_fu_224_p1;
wire   [7:0] add_ln1494_fu_228_p2;
wire   [0:0] icmp_ln1494_fu_244_p2;
wire   [7:0] zext_ln1265_fu_270_p1;
wire   [7:0] add_ln1265_fu_274_p2;
wire   [7:0] zext_ln1265_1_fu_312_p1;
wire   [7:0] add_ln1265_1_fu_316_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln267_fu_175_p2 == 1'd0))) begin
        sub_ln203_reg_352[7 : 1] <= sub_ln203_fu_207_p2[7 : 1];
    end
end
...
assign i_fu_181_p2 = (i_0_reg_97 + 5'd1);

assign icmp_ln1494_fu_244_p2 = (($signed(input_0_V_q0) > $signed(p_Val2_33_0_reg_108)) ? 1'b1 : 1'b0);

assign icmp_ln267_fu_175_p2 = ((i_0_reg_97 == 5'd16) ? 1'b1 : 1'b0);
