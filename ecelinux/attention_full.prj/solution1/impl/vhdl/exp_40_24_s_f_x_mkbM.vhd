...
entity exp_40_24_s_f_x_mkbM_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of exp_40_24_s_f_x_mkbM_rom is 
...
entity exp_40_24_s_f_x_mkbM is
    generic (
...
architecture arch of exp_40_24_s_f_x_mkbM is
    component exp_40_24_s_f_x_mkbM_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    exp_40_24_s_f_x_mkbM_rom_U :  component exp_40_24_s_f_x_mkbM_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
