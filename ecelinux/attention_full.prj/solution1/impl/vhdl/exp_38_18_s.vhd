...
architecture behav of exp_38_18_s is 
    ...
    signal p_Result_s_97_fu_454_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_Val2_39_fu_1044_p3 : STD_LOGIC_VECTOR (45 downto 0);
    signal tmp_76_fu_1052_p4 : STD_LOGIC_VECTOR (1 downto 0);
    signal icmp_ln456_fu_1062_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_77_fu_1068_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_78_fu_1082_p4 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    component dut_mul_42ns_44nspcA IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component dut_mul_48ns_50nsqcK IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component dut_mul_50ns_50nsrcU IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component dut_mac_muladd_3nsc4 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component exp_38_18_s_f_x_mjbC IS
    generic (
        DataWidth : INTEGER;
    ...
    component exp_38_18_s_f_x_mkbM IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component exp_38_18_s_f_x_llbW IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component exp_38_18_s_f_x_mncg IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component exp_38_18_s_exp_xocq IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    f_x_msb_4_h_table_V_U : component exp_38_18_s_f_x_mjbC
    generic map (
        DataWidth => 6,
        AddressRange => 8,
        AddressWidth => 3)
    ...
    f_x_msb_4_l_table_V_U : component exp_38_18_s_f_x_mkbM
    generic map (
        DataWidth => 7,
        AddressRange => 8,
        AddressWidth => 3)
    ...
    f_x_lsb_table_V_U : component exp_38_18_s_f_x_llbW
    generic map (
        DataWidth => 8,
        AddressRange => 16,
        AddressWidth => 4)
    ...
    f_x_msb_3_table_V_U : component exp_38_18_s_f_x_mmb6
    generic map (
        DataWidth => 32,
        AddressRange => 32,
        AddressWidth => 5)
    ...
    f_x_msb_2_table_V_U : component exp_38_18_s_f_x_mncg
    generic map (
        DataWidth => 46,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    exp_x_msb_1_table_V_U : component exp_38_18_s_exp_xocq
    generic map (
        DataWidth => 50,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    dut_mul_42ns_44nspcA_U37 : component dut_mul_42ns_44nspcA
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 42,
    ...
    dut_mul_48ns_50nsqcK_U38 : component dut_mul_48ns_50nsqcK
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 48,
    ...
    dut_mul_50ns_50nsrcU_U39 : component dut_mul_50ns_50nsrcU
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 50,
    ...
    dut_mac_muladd_3nsc4_U40 : component dut_mac_muladd_3nsc4
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 3,
    ...
    icmp_ln456_1_fu_1092_p2 <= "0" when (tmp_78_fu_1082_p4 = ap_const_lv3_0) else "1";
    icmp_ln456_fu_1062_p2 <= "0" when (tmp_76_fu_1052_p4 = ap_const_lv2_0) else "1";
    ...
    or_ln456_fu_1076_p2 <= (tmp_77_fu_1068_p3 or icmp_ln456_fu_1062_p2);
    ...
    p_Result_s_97_fu_454_p3 <= x_l_V_fu_268_p1(34 downto 34);
    p_Result_s_fu_314_p3 <= x_l_V_fu_268_p1(24 downto 24);
    p_Val2_39_fu_1044_p3 <= 
    ...
    select_ln282_fu_1032_p3 <= 
        ...
        ap_const_lv46_0;
    tmp_76_fu_1052_p4 <= p_Val2_39_fu_1044_p3(45 downto 44);
    tmp_77_fu_1068_p3 <= p_Val2_39_fu_1044_p3(43 downto 43);
    tmp_78_fu_1082_p4 <= p_Val2_39_fu_1044_p3(42 downto 40);
    ...
    tmp_s_fu_1104_p4 <= p_Val2_39_fu_1044_p3(40 downto 3);
    ...
    xor_ln278_10_fu_462_p2 <= (tmp_fu_306_p3 xor p_Result_s_97_fu_454_p3);
