...
// ==============================================================
#ifndef __dut_mul_60ns_58s_pac__HH__
#define __dut_mul_60ns_58s_pac__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_60ns_58s_pac) {
    ...
    SC_CTOR(dut_mul_60ns_58s_pac):  ACMP_mul_us_U ("ACMP_mul_us_U") {
