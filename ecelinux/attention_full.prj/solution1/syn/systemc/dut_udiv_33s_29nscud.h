...
// ==============================================================
#ifndef __dut_udiv_33s_29nscud__HH__
#define __dut_udiv_33s_29nscud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_udiv_33s_29nscud) {
    ...
    SC_CTOR(dut_udiv_33s_29nscud):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
