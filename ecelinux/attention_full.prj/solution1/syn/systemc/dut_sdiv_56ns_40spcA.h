...
// ==============================================================
#ifndef __dut_sdiv_56ns_40spcA__HH__
#define __dut_sdiv_56ns_40spcA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_sdiv_56ns_40spcA) {
    ...
    ACMP_sdiv_seq<ID, 60, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_sdiv_seq_U;

    SC_CTOR(dut_sdiv_56ns_40spcA):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
