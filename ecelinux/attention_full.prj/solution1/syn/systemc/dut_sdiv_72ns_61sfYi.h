...
// ==============================================================
#ifndef __dut_sdiv_72ns_61sfYi__HH__
#define __dut_sdiv_72ns_61sfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_sdiv_72ns_61sfYi) {
    ...
    SC_CTOR(dut_sdiv_72ns_61sfYi):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
