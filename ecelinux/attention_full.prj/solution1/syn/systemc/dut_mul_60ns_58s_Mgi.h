...
// ==============================================================
#ifndef __dut_mul_60ns_58s_Mgi__HH__
#define __dut_mul_60ns_58s_Mgi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_60ns_58s_Mgi) {
    ...
    SC_CTOR(dut_mul_60ns_58s_Mgi):  ACMP_mul_us_U ("ACMP_mul_us_U") {
