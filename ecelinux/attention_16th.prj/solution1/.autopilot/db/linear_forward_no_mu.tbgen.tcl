...
set C_modelArgList {
	{ input_0_V int 8 regular {array 96 { 1 3 } 1 1 }  }
	{ output_0_V int 40 regular {array 96 { 2 3 } 1 1 }  }
	{ scales_0_V_read int 40 regular  }
	{ packed_weights int 8 regular {array 2304 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ output_0_V_address0 sc_out sc_lv 7 signal 1 } 
	...
	{ packed_weights_address0 sc_out sc_lv 12 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "packed_weights_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "packed_weights", "role": "address0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "21313", "Max" : "42049"}
	, {"Name" : "Interval", "Min" : "21313", "Max" : "42049"}
]}
...
set Spec2ImplPortList { 
	input_0_V { ap_memory {  { input_0_V_address0 mem_address 1 7 }  { input_0_V_ce0 mem_ce 1 1 }  { input_0_V_q0 mem_dout 0 8 } } }
	...
	packed_weights { ap_memory {  { packed_weights_address0 mem_address 1 12 }  { packed_weights_ce0 mem_ce 1 1 }  { packed_weights_q0 mem_dout 0 8 } } }
