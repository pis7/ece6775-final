...
set C_modelArgList {
	{ input_1_0_V int 40 regular {array 24 { 1 1 } 1 1 }  }
	{ input_2_V int 40 regular {array 576 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ output_0_V_q0 sc_in sc_lv 40 signal 2 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	input_1_0_V { ap_memory {  { input_1_0_V_address0 mem_address 1 5 }  { input_1_0_V_ce0 mem_ce 1 1 }  { input_1_0_V_q0 mem_dout 0 40 }  { input_1_0_V_address1 MemPortADDR2 1 5 }  { input_1_0_V_ce1 MemPortCE2 1 1 }  { input_1_0_V_q1 MemPortDOUT2 0 40 } } }
	input_2_V { ap_memory {  { input_2_V_address0 mem_address 1 10 }  { input_2_V_ce0 mem_ce 1 1 }  { input_2_V_q0 mem_dout 0 40 }  { input_2_V_address1 MemPortADDR2 1 10 }  { input_2_V_ce1 MemPortCE2 1 1 }  { input_2_V_q1 MemPortDOUT2 0 40 } } }
