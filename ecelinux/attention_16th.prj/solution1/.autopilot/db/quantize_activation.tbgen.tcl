...
set C_modelArgList {
	{ input_0_V int 38 regular {array 96 { 1 1 } 1 1 }  }
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "495", "Max" : "495"}
	, {"Name" : "Interval", "Min" : "495", "Max" : "495"}
]}
...
set Spec2ImplPortList { 
	input_0_V { ap_memory {  { input_0_V_address0 mem_address 1 7 }  { input_0_V_ce0 mem_ce 1 1 }  { input_0_V_q0 mem_dout 0 38 }  { input_0_V_address1 MemPortADDR2 1 7 }  { input_0_V_ce1 MemPortCE2 1 1 }  { input_0_V_q1 MemPortDOUT2 0 38 } } }
