...
set C_modelArgList {
	{ mem_0_V int 38 regular {array 96 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ mem_0_V_address0 sc_out sc_lv 7 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mem_0_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "mem_0_V", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	mem_0_V { ap_memory {  { mem_0_V_address0 mem_address 1 7 }  { mem_0_V_ce0 mem_ce 1 1 }  { mem_0_V_we0 mem_we 1 1 }  { mem_0_V_d0 mem_din 1 38 } } }
}
