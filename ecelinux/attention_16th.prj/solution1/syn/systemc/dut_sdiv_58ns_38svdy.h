...
// ==============================================================
#ifndef __dut_sdiv_58ns_38svdy__HH__
#define __dut_sdiv_58ns_38svdy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_sdiv_58ns_38svdy) {
    ...
    SC_CTOR(dut_sdiv_58ns_38svdy):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
