...
// ==============================================================
#ifndef __dut_mul_40s_42ns_bkb__HH__
#define __dut_mul_40s_42ns_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_40s_42ns_bkb) {
    ...
    SC_CTOR(dut_mul_40s_42ns_bkb):  ACMP_mul_su_U ("ACMP_mul_su_U") {
