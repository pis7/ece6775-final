...
// ==============================================================
#ifndef __dut_mul_58ns_56s_KfY__HH__
#define __dut_mul_58ns_56s_KfY__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_58ns_56s_KfY) {
    ...
    SC_CTOR(dut_mul_58ns_56s_KfY):  ACMP_mul_us_U ("ACMP_mul_us_U") {
