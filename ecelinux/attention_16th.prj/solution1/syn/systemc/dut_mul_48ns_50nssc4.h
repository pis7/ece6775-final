...
// ==============================================================
#ifndef __dut_mul_48ns_50nssc4__HH__
#define __dut_mul_48ns_50nssc4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_48ns_50nssc4) {
    ...
    SC_CTOR(dut_mul_48ns_50nssc4):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
