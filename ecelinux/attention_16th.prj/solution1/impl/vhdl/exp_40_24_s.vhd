...
architecture behav of exp_40_24_s is 
    ...
    signal p_Result_s_98_fu_355_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_59_fu_807_p4 : STD_LOGIC_VECTOR (38 downto 0);
    ...
    component dut_mul_50ns_47nspcA IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component dut_mul_50ns_50nsqcK IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component exp_40_24_s_f_x_mmb6 IS
    generic (
        DataWidth : INTEGER;
    ...
    component exp_40_24_s_f_x_mncg IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component exp_40_24_s_exp_xocq IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    f_x_msb_3_table_V_U : component exp_40_24_s_f_x_mmb6
    generic map (
        DataWidth => 32,
        AddressRange => 32,
        AddressWidth => 5)
    ...
    f_x_msb_2_table_V_U : component exp_40_24_s_f_x_mncg
    generic map (
        DataWidth => 46,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    exp_x_msb_1_table_V_U : component exp_40_24_s_exp_xocq
    generic map (
        DataWidth => 50,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    dut_mul_50ns_47nspcA_U42 : component dut_mul_50ns_47nspcA
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 50,
    ...
    dut_mul_50ns_50nsqcK_U43 : component dut_mul_50ns_50nsqcK
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 50,
    ...
    p_Result_s_98_fu_355_p3 <= zext_ln727_fu_181_p1(30 downto 30);
    ...
    tmp_59_fu_807_p4 <= y_l_V_fu_784_p2(49 downto 11);
    ...
    xor_ln278_10_fu_363_p2 <= (tmp_fu_207_p3 xor p_Result_s_98_fu_355_p3);
    ...
    zext_ln708_fu_817_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_59_fu_807_p4),40));
