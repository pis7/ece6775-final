...
(* CORE_GENERATION_INFO="dut,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=19333,HLS_SYN_TPT=none,HLS_SYN_MEM=86,HLS_SYN_DSP=122,HLS_SYN_FF=21432,HLS_SYN_LUT=27650,HLS_VERSION=2019_2}" *)
...
wire   [0:0] icmp_ln19_fu_223_p2;
reg    strm_out_V_V_blk_n;
wire    ap_CS_fsm_state5;
wire   [6:0] add_ln19_fu_229_p2;
reg    ap_block_state2;
wire   [6:0] add_ln51_fu_261_p2;
reg   [6:0] add_ln51_reg_296;
wire    ap_CS_fsm_state4;
wire   [0:0] icmp_ln51_fu_255_p2;
...
wire   [6:0] grp_attention_fu_167_hidden_states_0_V_address0;
wire    grp_attention_fu_167_hidden_states_0_V_ce0;
wire    grp_attention_fu_167_hidden_states_0_V_we0;
wire   [39:0] grp_attention_fu_167_hidden_states_0_V_d0;
wire   [6:0] grp_attention_fu_167_hidden_states_0_V_address1;
wire    grp_attention_fu_167_hidden_states_0_V_ce1;
wire   [6:0] grp_attention_fu_167_final_output_0_V_address0;
...
wire   [6:0] grp_attention_fu_167_final_output_0_V_address1;
...
reg   [6:0] j_0_0_reg_145;
reg   [6:0] j9_0_0_reg_156;
wire    ap_CS_fsm_state3;
reg    grp_attention_fu_167_ap_start_reg;
reg    ap_block_state2_ignore_call0;
wire   [63:0] zext_ln20_fu_235_p1;
wire   [63:0] zext_ln52_fu_267_p1;
wire  signed [39:0] sext_ln708_fu_250_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((icmp_ln19_fu_223_p2 == 1'd0) & (strm_in_V_V_empty_n == 1'b0)) & (icmp_ln19_fu_223_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((grp_attention_fu_167_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
        j9_0_0_reg_156 <= 7'd0;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        j_0_0_reg_145 <= 7'd0;
    end else if ((~((icmp_ln19_fu_223_p2 == 1'd0) & (strm_in_V_V_empty_n == 1'b0)) & (icmp_ln19_fu_223_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if (((icmp_ln51_fu_255_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln19_fu_223_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        input_0_V_address0 = zext_ln20_fu_235_p1;
...
always @ (*) begin
    if ((~((icmp_ln19_fu_223_p2 == 1'd0) & (strm_in_V_V_empty_n == 1'b0)) & (icmp_ln19_fu_223_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        input_0_V_ce0 = 1'b1;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        output_0_address0 = zext_ln52_fu_267_p1;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if ((~((icmp_ln19_fu_223_p2 == 1'd0) & (strm_in_V_V_empty_n == 1'b0)) & (icmp_ln19_fu_223_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if ((~((icmp_ln19_fu_223_p2 == 1'd0) & (strm_in_V_V_empty_n == 1'b0)) & (icmp_ln19_fu_223_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign add_ln19_fu_229_p2 = (j_0_0_reg_145 + 7'd1);

assign add_ln51_fu_261_p2 = (j9_0_0_reg_156 + 7'd1);
...
always @ (*) begin
    ap_block_state2 = ((icmp_ln19_fu_223_p2 == 1'd0) & (strm_in_V_V_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state2_ignore_call0 = ((icmp_ln19_fu_223_p2 == 1'd0) & (strm_in_V_V_empty_n == 1'b0));
end

assign grp_attention_fu_167_ap_start = grp_attention_fu_167_ap_start_reg;

assign icmp_ln19_fu_223_p2 = ((j_0_0_reg_145 == 7'd96) ? 1'b1 : 1'b0);

assign icmp_ln51_fu_255_p2 = ((j9_0_0_reg_156 == 7'd96) ? 1'b1 : 1'b0);

assign sext_ln708_fu_250_p1 = $signed(trunc_ln_fu_240_p4);
...
assign zext_ln20_fu_235_p1 = j_0_0_reg_145;

assign zext_ln52_fu_267_p1 = j9_0_0_reg_156;
