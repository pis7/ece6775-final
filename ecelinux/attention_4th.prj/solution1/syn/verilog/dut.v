...
(* CORE_GENERATION_INFO="dut,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=90385,HLS_SYN_TPT=none,HLS_SYN_MEM=221,HLS_SYN_DSP=92,HLS_SYN_FF=22371,HLS_SYN_LUT=35920,HLS_VERSION=2019_2}" *)
...
reg    ap_block_state2;
wire   [8:0] add_ln51_fu_453_p2;
reg   [8:0] add_ln51_reg_488;
wire    ap_CS_fsm_state4;
wire   [0:0] icmp_ln51_fu_447_p2;
...
reg    output_0_ce1;
reg    output_0_we1;
wire    grp_attention_fu_263_ap_start;
wire    grp_attention_fu_263_ap_done;
wire    grp_attention_fu_263_ap_idle;
wire    grp_attention_fu_263_ap_ready;
wire   [8:0] grp_attention_fu_263_hidden_states_0_V_address0;
wire    grp_attention_fu_263_hidden_states_0_V_ce0;
wire    grp_attention_fu_263_hidden_states_0_V_we0;
wire   [39:0] grp_attention_fu_263_hidden_states_0_V_d0;
wire   [8:0] grp_attention_fu_263_hidden_states_0_V_address1;
wire    grp_attention_fu_263_hidden_states_0_V_ce1;
wire   [8:0] grp_attention_fu_263_final_output_0_V_address0;
wire    grp_attention_fu_263_final_output_0_V_ce0;
wire    grp_attention_fu_263_final_output_0_V_we0;
wire   [39:0] grp_attention_fu_263_final_output_0_V_d0;
wire   [8:0] grp_attention_fu_263_final_output_0_V_address1;
wire    grp_attention_fu_263_final_output_0_V_ce1;
wire    grp_attention_fu_263_final_output_0_V_we1;
wire   [39:0] grp_attention_fu_263_final_output_0_V_d1;
reg   [8:0] j_0_0_reg_241;
reg   [8:0] j9_0_0_reg_252;
wire    ap_CS_fsm_state3;
reg    grp_attention_fu_263_ap_start_reg;
reg    ap_block_state2_ignore_call0;
wire   [63:0] zext_ln20_fu_427_p1;
wire   [63:0] zext_ln52_fu_459_p1;
wire  signed [39:0] sext_ln708_fu_442_p1;
wire   [29:0] trunc_ln_fu_432_p4;
wire   [29:0] trunc_ln731_fu_464_p1;
reg   [4:0] ap_NS_fsm;

// power-on initialization
initial begin
#0 ap_CS_fsm = 5'd1;
#0 grp_attention_fu_263_ap_start_reg = 1'b0;
end
...
attention grp_attention_fu_263(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_attention_fu_263_ap_start_reg <= 1'b0;
    end else begin
        if ((~((icmp_ln19_fu_415_p2 == 1'd0) & (strm_in_V_V_empty_n == 1'b0)) & (icmp_ln19_fu_415_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            grp_attention_fu_263_ap_start_reg <= 1'b1;
        end else if ((grp_attention_fu_263_ap_ready == 1'b1)) begin
            grp_attention_fu_263_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((grp_attention_fu_263_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
        j9_0_0_reg_252 <= 9'd0;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        j_0_0_reg_241 <= 9'd0;
    end else if ((~((icmp_ln19_fu_415_p2 == 1'd0) & (strm_in_V_V_empty_n == 1'b0)) & (icmp_ln19_fu_415_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if (((icmp_ln51_fu_447_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln19_fu_415_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        input_0_V_address0 = zext_ln20_fu_427_p1;
...
always @ (*) begin
    if ((~((icmp_ln19_fu_415_p2 == 1'd0) & (strm_in_V_V_empty_n == 1'b0)) & (icmp_ln19_fu_415_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        input_0_V_ce0 = 1'b1;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        output_0_address0 = zext_ln52_fu_459_p1;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if ((~((icmp_ln19_fu_415_p2 == 1'd0) & (strm_in_V_V_empty_n == 1'b0)) & (icmp_ln19_fu_415_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if ((~((icmp_ln19_fu_415_p2 == 1'd0) & (strm_in_V_V_empty_n == 1'b0)) & (icmp_ln19_fu_415_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign add_ln19_fu_421_p2 = (j_0_0_reg_241 + 9'd1);

assign add_ln51_fu_453_p2 = (j9_0_0_reg_252 + 9'd1);
...
always @ (*) begin
    ap_block_state2 = ((icmp_ln19_fu_415_p2 == 1'd0) & (strm_in_V_V_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state2_ignore_call0 = ((icmp_ln19_fu_415_p2 == 1'd0) & (strm_in_V_V_empty_n == 1'b0));
end

assign grp_attention_fu_263_ap_start = grp_attention_fu_263_ap_start_reg;

assign icmp_ln19_fu_415_p2 = ((j_0_0_reg_241 == 9'd384) ? 1'b1 : 1'b0);

assign icmp_ln51_fu_447_p2 = ((j9_0_0_reg_252 == 9'd384) ? 1'b1 : 1'b0);

assign sext_ln708_fu_442_p1 = $signed(trunc_ln_fu_432_p4);

assign strm_out_V_V_din = {{trunc_ln731_fu_464_p1}, {2'd0}};

assign trunc_ln731_fu_464_p1 = output_0_q0[29:0];

assign trunc_ln_fu_432_p4 = {{strm_in_V_V_dout[31:2]}};

assign zext_ln20_fu_427_p1 = j_0_0_reg_241;

assign zext_ln52_fu_459_p1 = j9_0_0_reg_252;
