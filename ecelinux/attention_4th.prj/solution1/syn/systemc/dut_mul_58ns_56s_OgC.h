...
// ==============================================================
#ifndef __dut_mul_58ns_56s_OgC__HH__
#define __dut_mul_58ns_56s_OgC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_58ns_56s_OgC) {
    ...
    SC_CTOR(dut_mul_58ns_56s_OgC):  ACMP_mul_us_U ("ACMP_mul_us_U") {
