...
// ==============================================================
#ifndef __dut_mul_50ns_50nsocq__HH__
#define __dut_mul_50ns_50nsocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_50ns_50nsocq) {
    ...
    SC_CTOR(dut_mul_50ns_50nsocq):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
