...
architecture behav of dut is 
    ...
    "dut,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=74129,HLS_SYN_TPT=none,HLS_SYN_MEM=242,HLS_SYN_DSP=192,HLS_SYN_FF=26679,HLS_SYN_LUT=40589,HLS_VERSION=2019_2}";
