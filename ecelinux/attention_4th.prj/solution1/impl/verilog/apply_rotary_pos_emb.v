...
wire   [4:0] add_ln204_fu_354_p2;
reg   [4:0] add_ln204_reg_574;
...
wire   [5:0] add_ln216_fu_454_p2;
reg   [5:0] add_ln216_reg_627;
...
wire   [5:0] zext_ln204_fu_344_p1;
wire   [5:0] add_ln205_fu_375_p2;
...
assign add_ln204_fu_354_p2 = (k_0_0_reg_265 + 5'd1);

assign add_ln205_fu_375_p2 = (zext_ln204_fu_344_p1 + 6'd24);

assign add_ln216_fu_454_p2 = (k16_0_0_reg_287 + 6'd1);
...
assign icmp_ln202_fu_306_p2 = ((i_0_reg_254 == 4'd8) ? 1'b1 : 1'b0);

assign icmp_ln204_fu_348_p2 = ((k_0_0_reg_265 == 5'd24) ? 1'b1 : 1'b0);

assign icmp_ln214_fu_410_p2 = ((i14_0_reg_276 == 4'd8) ? 1'b1 : 1'b0);

assign icmp_ln216_fu_448_p2 = ((k16_0_0_reg_287 == 6'd48) ? 1'b1 : 1'b0);
