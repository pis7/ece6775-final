...
architecture behav of init_2d_mem is 
    ...
    signal add_ln37_fu_57_p2 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    add_ln37_fu_57_p2 <= std_logic_vector(unsigned(j_0_0_reg_40) + unsigned(ap_const_lv9_1));
    ...
    icmp_ln37_fu_51_p2 <= "1" when (j_0_0_reg_40 = ap_const_lv9_180) else "0";
    mem_0_V_address0 <= zext_ln38_fu_63_p1(9 - 1 downto 0);
