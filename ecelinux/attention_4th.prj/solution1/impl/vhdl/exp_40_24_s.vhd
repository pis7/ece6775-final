...
architecture behav of exp_40_24_s is 
    ...
    signal p_Result_s_101_fu_355_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_90_fu_807_p4 : STD_LOGIC_VECTOR (38 downto 0);
...
begin
    ...
    dut_mul_50ns_47nsncg_U49 : component dut_mul_50ns_47nsncg
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 50,
    ...
    dut_mul_50ns_50nsocq_U50 : component dut_mul_50ns_50nsocq
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 50,
    ...
    p_Result_s_101_fu_355_p3 <= zext_ln727_fu_181_p1(30 downto 30);
    ...
    tmp_90_fu_807_p4 <= y_l_V_fu_784_p2(49 downto 11);
    ...
    xor_ln278_10_fu_363_p2 <= (tmp_fu_207_p3 xor p_Result_s_101_fu_355_p3);
    ...
    zext_ln708_fu_817_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_90_fu_807_p4),40));
