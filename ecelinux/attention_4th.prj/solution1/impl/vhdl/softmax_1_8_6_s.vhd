...
architecture behav of softmax_1_8_6_s is 
    ...
    signal sub_ln203_fu_207_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal sub_ln203_reg_352 : STD_LOGIC_VECTOR (6 downto 0);
    signal icmp_ln267_fu_175_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal icmp_ln270_fu_218_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln270_fu_238_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal add_ln270_reg_377 : STD_LOGIC_VECTOR (2 downto 0);
    signal select_ln271_fu_250_p3 : STD_LOGIC_VECTOR (39 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal add_ln273_fu_264_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal add_ln273_reg_390 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_CS_fsm_state6 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state6 : signal is "none";
    signal input_0_V_addr_2_reg_395 : STD_LOGIC_VECTOR (5 downto 0);
    signal icmp_ln273_fu_258_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln278_fu_306_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal add_ln278_reg_418 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_CS_fsm_state16 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state16 : signal is "none";
    signal input_0_V_addr_3_reg_423 : STD_LOGIC_VECTOR (5 downto 0);
    signal icmp_ln278_fu_300_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal i_0_reg_97 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal tmp_53_fu_195_p3 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_s_fu_187_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal zext_ln203_fu_203_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal zext_ln1494_fu_224_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln1494_fu_228_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal icmp_ln1494_fu_244_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln1265_fu_270_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln1265_fu_274_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal zext_ln1265_1_fu_312_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln1265_1_fu_316_p2 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    component dut_sdiv_56ns_40spcA IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    dut_sdiv_56ns_40spcA_U248 : component dut_sdiv_56ns_40spcA
    generic map (
        ID => 1,
        NUM_STAGE => 60,
        din0_WIDTH => 56,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state16) and (icmp_ln278_fu_300_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state4) and (icmp_ln270_fu_218_p2 = ap_const_lv1_1))) then 
                k1_0_0_reg_141 <= ap_const_lv3_0;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state15)) then 
                k1_0_0_reg_141 <= add_ln273_reg_390;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state6) and (icmp_ln273_fu_258_p2 = ap_const_lv1_1))) then 
                k2_0_0_reg_152 <= ap_const_lv3_0;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state76)) then 
                k2_0_0_reg_152 <= add_ln278_reg_418;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
                k_0_0_reg_118 <= add_ln270_reg_377;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
                p_Val2_33_0_reg_108 <= select_ln271_fu_250_p3;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state4) and (icmp_ln270_fu_218_p2 = ap_const_lv1_0))) then
                add_ln270_reg_377 <= add_ln270_fu_238_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state6)) then
                add_ln273_reg_390 <= add_ln273_fu_264_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state16)) then
                add_ln278_reg_418 <= add_ln278_fu_306_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state6) and (icmp_ln273_fu_258_p2 = ap_const_lv1_0))) then
                input_0_V_addr_2_reg_395 <= sext_ln1265_fu_279_p1(6 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state16) and (icmp_ln278_fu_300_p2 = ap_const_lv1_0))) then
                input_0_V_addr_3_reg_423 <= sext_ln1265_1_fu_321_p1(6 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln267_fu_175_p2 = ap_const_lv1_0))) then
                    sub_ln203_reg_352(6 downto 1) <= sub_ln203_fu_207_p2(6 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln267_fu_175_p2, ap_CS_fsm_state4, icmp_ln270_fu_218_p2, ap_CS_fsm_state6, icmp_ln273_fu_258_p2, ap_CS_fsm_state16, icmp_ln278_fu_300_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln267_fu_175_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
    ...
    add_ln270_fu_238_p2 <= std_logic_vector(unsigned(k_0_0_reg_118) + unsigned(ap_const_lv3_1));
    add_ln273_fu_264_p2 <= std_logic_vector(unsigned(k1_0_0_reg_141) + unsigned(ap_const_lv3_1));
    add_ln278_fu_306_p2 <= std_logic_vector(unsigned(k2_0_0_reg_152) + unsigned(ap_const_lv3_1));
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln267_fu_175_p2)
    begin
        if ((((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)) or ((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln267_fu_175_p2 = ap_const_lv1_1)))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, icmp_ln267_fu_175_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln267_fu_175_p2 = ap_const_lv1_1))) then 
    ...
    i_fu_181_p2 <= std_logic_vector(unsigned(i_0_reg_97) + unsigned(ap_const_lv4_1));
    icmp_ln1494_fu_244_p2 <= "1" when (signed(input_0_V_q0) > signed(p_Val2_33_0_reg_108)) else "0";
    icmp_ln267_fu_175_p2 <= "1" when (i_0_reg_97 = ap_const_lv4_8) else "0";
    icmp_ln270_fu_218_p2 <= "1" when (k_0_0_reg_118 = ap_const_lv3_6) else "0";
    icmp_ln273_fu_258_p2 <= "1" when (k1_0_0_reg_141 = ap_const_lv3_6) else "0";
    icmp_ln278_fu_300_p2 <= "1" when (k2_0_0_reg_152 = ap_const_lv3_6) else "0";
    ...
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state76)) then 
            ...
            input_0_V_address0 <= sext_ln1265_1_fu_321_p1(6 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state15)) then 
            input_0_V_address0 <= input_0_V_addr_2_reg_395;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            input_0_V_address0 <= sext_ln1265_fu_279_p1(6 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            input_0_V_address0 <= sext_ln1494_fu_233_p1(6 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            input_0_V_address0 <= sext_ln203_fu_213_p1(6 - 1 downto 0);
        else 
    ...
    zext_ln1265_1_fu_312_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(k2_0_0_reg_152),7));
    zext_ln1265_fu_270_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(k1_0_0_reg_141),7));
    zext_ln1494_fu_224_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(k_0_0_reg_118),7));
    zext_ln203_fu_203_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_53_fu_195_p3),7));
end behav;
