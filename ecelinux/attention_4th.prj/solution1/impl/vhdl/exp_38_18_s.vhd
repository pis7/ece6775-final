...
architecture behav of exp_38_18_s is 
    ...
    signal p_Result_s_94_fu_454_p3 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    dut_mul_42ns_44nspcA_U238 : component dut_mul_42ns_44nspcA
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 42,
    ...
    dut_mul_48ns_50nsqcK_U239 : component dut_mul_48ns_50nsqcK
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 48,
    ...
    dut_mul_50ns_50nsrcU_U240 : component dut_mul_50ns_50nsrcU
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 50,
    ...
    dut_mac_muladd_3nsc4_U241 : component dut_mac_muladd_3nsc4
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 3,
    ...
    p_Result_s_94_fu_454_p3 <= x_l_V_fu_268_p1(34 downto 34);
    ...
    xor_ln278_10_fu_462_p2 <= (tmp_fu_306_p3 xor p_Result_s_94_fu_454_p3);
