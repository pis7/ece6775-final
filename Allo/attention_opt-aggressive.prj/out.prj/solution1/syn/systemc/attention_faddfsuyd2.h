...
// ==============================================================
#ifndef __attention_faddfsuyd2__HH__
#define __attention_faddfsuyd2__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_faddfsuyd2) {
    ...
    SC_CTOR(attention_faddfsuyd2):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
