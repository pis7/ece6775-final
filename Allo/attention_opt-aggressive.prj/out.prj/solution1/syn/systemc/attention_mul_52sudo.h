...
// ==============================================================
#ifndef __attention_mul_52sudo__HH__
#define __attention_mul_52sudo__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_mul_52sudo) {
    ...
    SC_CTOR(attention_mul_52sudo):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
