...
set C_modelArgList {
	{ v204 float 32 regular {array 9216 { 1 3 } 1 1 }  }
	{ v205 float 32 regular {array 9216 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ v204_address0 sc_out sc_lv 14 signal 0 } 
	{ v204_ce0 sc_out sc_logic 1 signal 0 } 
	{ v204_q0 sc_in sc_lv 32 signal 0 } 
	{ v205_address0 sc_out sc_lv 14 signal 1 } 
	{ v205_ce0 sc_out sc_logic 1 signal 1 } 
	{ v205_we0 sc_out sc_logic 1 signal 1 } 
	{ v205_d0 sc_out sc_lv 32 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v205_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "v205", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	v204 { ap_memory {  { v204_address0 mem_address 1 14 }  { v204_ce0 mem_ce 1 1 }  { v204_q0 mem_dout 0 32 } } }
	v205 { ap_memory {  { v205_address0 mem_address 1 14 }  { v205_ce0 mem_ce 1 1 }  { v205_we0 mem_we 1 1 }  { v205_d0 mem_din 1 32 } } }
}
