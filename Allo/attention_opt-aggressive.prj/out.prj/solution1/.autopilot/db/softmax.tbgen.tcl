...
set C_modelArgList {
	{ v225_0 float 32 regular {array 96 { 1 3 } 1 1 }  }
	{ v226_0 float 32 regular {array 96 { 2 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "v225_0", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "v226_0", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ v225_0_address0 sc_out sc_lv 7 signal 0 } 
	{ v225_0_ce0 sc_out sc_logic 1 signal 0 } 
	{ v225_0_q0 sc_in sc_lv 32 signal 0 } 
	{ v226_0_address0 sc_out sc_lv 7 signal 1 } 
	{ v226_0_ce0 sc_out sc_logic 1 signal 1 } 
	{ v226_0_we0 sc_out sc_logic 1 signal 1 } 
	{ v226_0_d0 sc_out sc_lv 32 signal 1 } 
	{ v226_0_q0 sc_in sc_lv 32 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v226_0_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "v226_0", "role": "address0" }} , 
 	...
 	{ "name": "v226_0_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v226_0", "role": "q0" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "16", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.attention_faddfsuyd2_U196", "Parent" : "0"},
	{"ID" : "17", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.attention_fdiv_32rcU_U197", "Parent" : "0"},
	{"ID" : "18", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.attention_fcmp_32tde_U198", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	v225_0 { ap_memory {  { v225_0_address0 mem_address 1 7 }  { v225_0_ce0 mem_ce 1 1 }  { v225_0_q0 mem_dout 0 32 } } }
	v226_0 { ap_memory {  { v226_0_address0 mem_address 1 7 }  { v226_0_ce0 mem_ce 1 1 }  { v226_0_we0 mem_we 1 1 }  { v226_0_d0 mem_din 1 32 }  { v226_0_q0 mem_dout 0 32 } } }
}
