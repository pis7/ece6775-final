...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename v81 \
    op interface \
    ports { v81_address0 { O 11 vector } v81_ce0 { O 1 bit } v81_we0 { O 1 bit } v81_d0 { O 32 vector } v81_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'v81'"
}
}
