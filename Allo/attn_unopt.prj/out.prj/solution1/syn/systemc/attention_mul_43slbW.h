...
// ==============================================================
#ifndef __attention_mul_43slbW__HH__
#define __attention_mul_43slbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_mul_43slbW) {
    ...
    SC_CTOR(attention_mul_43slbW):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
