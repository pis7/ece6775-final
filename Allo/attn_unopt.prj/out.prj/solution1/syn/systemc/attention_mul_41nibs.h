...
// ==============================================================
#ifndef __attention_mul_41nibs__HH__
#define __attention_mul_41nibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_mul_41nibs) {
    ...
    SC_CTOR(attention_mul_41nibs):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
