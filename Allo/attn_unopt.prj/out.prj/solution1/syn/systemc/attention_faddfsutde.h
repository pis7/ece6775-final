...
// ==============================================================
#ifndef __attention_faddfsutde__HH__
#define __attention_faddfsutde__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_faddfsutde) {
    ...
    SC_CTOR(attention_faddfsutde):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
