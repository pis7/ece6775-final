...
// ==============================================================
#ifndef __attention_mul_mulocq__HH__
#define __attention_mul_mulocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_mul_mulocq) {
    ...
    SC_CTOR(attention_mul_mulocq):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
