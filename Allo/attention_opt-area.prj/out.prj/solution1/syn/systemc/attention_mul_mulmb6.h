...
// ==============================================================
#ifndef __attention_mul_mulmb6__HH__
#define __attention_mul_mulmb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_mul_mulmb6) {
    ...
    SC_CTOR(attention_mul_mulmb6):  ACMP_smul_su_U ("ACMP_smul_su_U") {
