...
// ==============================================================
#ifndef __attention_fcmp_32tde__HH__
#define __attention_fcmp_32tde__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_fcmp_32tde) {
    ...
    SC_CTOR(attention_fcmp_32tde):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
