...
// ==============================================================
#ifndef __attention_fcmp_32sc4__HH__
#define __attention_fcmp_32sc4__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_fcmp_32sc4) {
    ...
    SC_CTOR(attention_fcmp_32sc4):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
