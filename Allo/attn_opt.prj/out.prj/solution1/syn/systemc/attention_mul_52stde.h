...
// ==============================================================
#ifndef __attention_mul_52stde__HH__
#define __attention_mul_52stde__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_mul_52stde) {
    ...
    SC_CTOR(attention_mul_52stde):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
