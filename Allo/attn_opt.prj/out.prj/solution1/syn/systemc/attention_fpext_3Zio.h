...
// ==============================================================
#ifndef __attention_fpext_3Zio__HH__
#define __attention_fpext_3Zio__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_fpext_3Zio) {
    ...
    SC_CTOR(attention_fpext_3Zio):  ACMP_fpext_U ("ACMP_fpext_U") {
