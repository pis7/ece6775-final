...
// ==============================================================
#ifndef __attention_mul_45nkbM__HH__
#define __attention_mul_45nkbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_mul_45nkbM) {
    ...
    SC_CTOR(attention_mul_45nkbM):  ACMP_mul_us_U ("ACMP_mul_us_U") {
