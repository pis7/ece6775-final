...
// ==============================================================
#ifndef __attention_faddfsuxdS__HH__
#define __attention_faddfsuxdS__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_faddfsuxdS) {
    ...
    SC_CTOR(attention_faddfsuxdS):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
