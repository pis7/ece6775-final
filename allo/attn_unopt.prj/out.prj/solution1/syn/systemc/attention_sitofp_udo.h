...
// ==============================================================
#ifndef __attention_sitofp_udo__HH__
#define __attention_sitofp_udo__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_sitofp_udo) {
    ...
    SC_CTOR(attention_sitofp_udo):  ACMP_sitofp_U ("ACMP_sitofp_U") {
