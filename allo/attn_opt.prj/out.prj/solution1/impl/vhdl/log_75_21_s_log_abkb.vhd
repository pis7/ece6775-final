...
entity log_75_21_s_log_abkb_rom is 
    generic(
             DWIDTH     : integer := 6; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of log_75_21_s_log_abkb_rom is 
...
entity log_75_21_s_log_abkb is
    generic (
        DataWidth : INTEGER := 6;
...
architecture arch of log_75_21_s_log_abkb is
    component log_75_21_s_log_abkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    log_75_21_s_log_abkb_rom_U :  component log_75_21_s_log_abkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
