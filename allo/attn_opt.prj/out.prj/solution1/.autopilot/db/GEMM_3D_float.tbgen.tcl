...
set C_modelArgList {
	{ v209_0 float 32 regular {array 1536 { 1 3 } 1 1 }  }
	{ v211_0 float 32 regular {array 96 { 2 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "v209_0", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "v211_0", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
...
set portList { 
	...
	{ v209_0_address0 sc_out sc_lv 11 signal 0 } 
	{ v209_0_ce0 sc_out sc_logic 1 signal 0 } 
	{ v209_0_q0 sc_in sc_lv 32 signal 0 } 
	{ v211_0_address0 sc_out sc_lv 7 signal 1 } 
	{ v211_0_ce0 sc_out sc_logic 1 signal 1 } 
	{ v211_0_we0 sc_out sc_logic 1 signal 1 } 
	{ v211_0_d0 sc_out sc_lv 32 signal 1 } 
	{ v211_0_q0 sc_in sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v209_0_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "v209_0", "role": "address0" }} , 
 	...
 	{ "name": "v211_0_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "v211_0", "role": "address0" }} , 
 	{ "name": "v211_0_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v211_0", "role": "ce0" }} , 
 	{ "name": "v211_0_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v211_0", "role": "we0" }} , 
 	{ "name": "v211_0_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v211_0", "role": "d0" }} , 
 	{ "name": "v211_0_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v211_0", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.attention_fadd_32pcA_U79", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.attention_fmul_32qcK_U80", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	v209_0 { ap_memory {  { v209_0_address0 mem_address 1 11 }  { v209_0_ce0 mem_ce 1 1 }  { v209_0_q0 mem_dout 0 32 } } }
	v211_0 { ap_memory {  { v211_0_address0 mem_address 1 7 }  { v211_0_ce0 mem_ce 1 1 }  { v211_0_we0 mem_we 1 1 }  { v211_0_d0 mem_din 1 32 }  { v211_0_q0 mem_dout 0 32 } } }
