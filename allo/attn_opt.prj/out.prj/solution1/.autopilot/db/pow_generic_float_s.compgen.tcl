...
set out_width 25
set exp i0*i1
set arg_lists {i0 {25 1 +} i1 {6 0 +} p {25 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
...
set out_width 25
set exp i0*i1+i2
set arg_lists {i0 {13 0 +} i1 {13 1 +} m {25 1 +} i2 {16 1 +} p {25 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set ID 15
set hasByteEnable 0
set MemName pow_generic_floatbkb
...
set ID 16
set hasByteEnable 0
set MemName pow_generic_floatcud
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 56
set AddrRange 64
...
set ID 17
set hasByteEnable 0
set MemName pow_generic_floatdEe
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 52
set AddrRange 16
...
set ID 18
set hasByteEnable 0
set MemName pow_generic_floateOg
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 49
set AddrRange 64
...
set ID 19
set hasByteEnable 0
set MemName pow_generic_floatfYi
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 44
set AddrRange 64
...
set ID 20
set hasByteEnable 0
set MemName pow_generic_floatg8j
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 27
set AddrRange 512
...
set ID 21
set hasByteEnable 0
set MemName pow_generic_floathbi
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 8
set AddrRange 32
