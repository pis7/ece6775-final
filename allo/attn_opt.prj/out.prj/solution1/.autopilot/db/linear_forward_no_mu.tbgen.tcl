...
set portList { 
	...
	{ v78_0_V_read sc_in sc_lv 32 signal 1 } 
	{ v79_address0 sc_out sc_lv 20 signal 2 } 
	{ v79_ce0 sc_out sc_logic 1 signal 2 } 
	{ v79_q0 sc_in sc_lv 8 signal 2 } 
	{ v80_V sc_in sc_lv 32 signal 3 } 
	{ v81_V_address0 sc_out sc_lv 11 signal 4 } 
	{ v81_V_ce0 sc_out sc_logic 1 signal 4 } 
	{ v81_V_we0 sc_out sc_logic 1 signal 4 } 
	{ v81_V_d0 sc_out sc_lv 32 signal 4 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.attention_sdiv_44yd2_U46", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2440705", "Max" : "2440705"}
	, {"Name" : "Interval", "Min" : "2440705", "Max" : "2440705"}
]}
