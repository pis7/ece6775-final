...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename v81_V \
    op interface \
    ports { v81_V_address0 { O 11 vector } v81_V_ce0 { O 1 bit } v81_V_we0 { O 1 bit } v81_V_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'v81_V'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_v78_0_V_read \
    op interface \
    ports { v78_0_V_read { I 32 vector } } \
} "
}
