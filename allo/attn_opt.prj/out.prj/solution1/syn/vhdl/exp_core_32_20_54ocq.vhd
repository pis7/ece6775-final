...
entity exp_core_32_20_54ocq_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of exp_core_32_20_54ocq_rom is 
...
entity exp_core_32_20_54ocq is
    generic (
...
architecture arch of exp_core_32_20_54ocq is
    component exp_core_32_20_54ocq_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    exp_core_32_20_54ocq_rom_U :  component exp_core_32_20_54ocq_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
