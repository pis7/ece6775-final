...
// ==============================================================
#ifndef __attention_mul_7s_lbW__HH__
#define __attention_mul_7s_lbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_mul_7s_lbW) {
    ...
    SC_CTOR(attention_mul_7s_lbW):  ACMP_mul_su_U ("ACMP_mul_su_U") {
