...
// ==============================================================
#ifndef __attention_am_addmAem__HH__
#define __attention_am_addmAem__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_am_addmAem) {
    ...
    SC_CTOR(attention_am_addmAem):  simcore_am_0_U ("simcore_am_0_U") {
