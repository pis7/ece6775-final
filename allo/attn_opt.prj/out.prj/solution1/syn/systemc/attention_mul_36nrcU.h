...
// ==============================================================
#ifndef __attention_mul_36nrcU__HH__
#define __attention_mul_36nrcU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_mul_36nrcU) {
    ...
    SC_CTOR(attention_mul_36nrcU):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
