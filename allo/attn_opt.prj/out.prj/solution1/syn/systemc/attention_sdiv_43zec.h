...
// ==============================================================
#ifndef __attention_sdiv_43zec__HH__
#define __attention_sdiv_43zec__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_sdiv_43zec) {
    ...
    SC_CTOR(attention_sdiv_43zec):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
