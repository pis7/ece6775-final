...
// ==============================================================
#ifndef __attention_mul_60njbC__HH__
#define __attention_mul_60njbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_mul_60njbC) {
    ...
    SC_CTOR(attention_mul_60njbC):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
