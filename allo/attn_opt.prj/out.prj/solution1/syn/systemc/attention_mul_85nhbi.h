...
// ==============================================================
#ifndef __attention_mul_85nhbi__HH__
#define __attention_mul_85nhbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_mul_85nhbi) {
    ...
    SC_CTOR(attention_mul_85nhbi):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
