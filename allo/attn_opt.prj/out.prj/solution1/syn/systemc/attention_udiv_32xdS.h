...
// ==============================================================
#ifndef __attention_udiv_32xdS__HH__
#define __attention_udiv_32xdS__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_udiv_32xdS) {
    ...
    SC_CTOR(attention_udiv_32xdS):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
