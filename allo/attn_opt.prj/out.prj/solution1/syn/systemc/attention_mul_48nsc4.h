...
// ==============================================================
#ifndef __attention_mul_48nsc4__HH__
#define __attention_mul_48nsc4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_mul_48nsc4) {
    ...
    SC_CTOR(attention_mul_48nsc4):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
