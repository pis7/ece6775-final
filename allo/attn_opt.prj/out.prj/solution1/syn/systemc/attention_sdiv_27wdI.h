...
// ==============================================================
#ifndef __attention_sdiv_27wdI__HH__
#define __attention_sdiv_27wdI__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_sdiv_27wdI) {
    ...
    ACMP_sdiv_seq<ID, 31, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_sdiv_seq_U;

    SC_CTOR(attention_sdiv_27wdI):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
