...
// ==============================================================
#ifndef __attention_sdiv_44Bew__HH__
#define __attention_sdiv_44Bew__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_sdiv_44Bew) {
    ...
    SC_CTOR(attention_sdiv_44Bew):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
