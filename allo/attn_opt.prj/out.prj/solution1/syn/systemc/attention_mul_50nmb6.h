...
// ==============================================================
#ifndef __attention_mul_50nmb6__HH__
#define __attention_mul_50nmb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_mul_50nmb6) {
    ...
    SC_CTOR(attention_mul_50nmb6):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
