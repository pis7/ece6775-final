...
// ==============================================================
#ifndef __attention_sdiv_44Ee0__HH__
#define __attention_sdiv_44Ee0__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_sdiv_44Ee0) {
    ...
    SC_CTOR(attention_sdiv_44Ee0):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
