...
// ==============================================================
#ifndef __attention_mul_46nvdy__HH__
#define __attention_mul_46nvdy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(attention_mul_46nvdy) {
    ...
    SC_CTOR(attention_mul_46nvdy):  ACMP_mul_us_U ("ACMP_mul_us_U") {
