...
public:
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 1726363, 1726363, 0)
    , catapult_monitor_INST("Monitor", clk, true, 1726363LL, 1726363LL)
...
void scverify_top::read_env() {
  ...
  unsigned long latency_est = 1726361;
