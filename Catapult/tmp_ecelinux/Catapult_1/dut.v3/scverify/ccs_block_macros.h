...
// linear_forward_no_mul 143 INLINE
#define ccs_intercept_linear_forward_no_mul_143 linear_forward_no_mul
// reshape_2D_to_3D 175 INLINE
#define ccs_intercept_reshape_2D_to_3D_175 reshape_2D_to_3D
// apply_rotary_pos_emb 189 INLINE
#define ccs_intercept_apply_rotary_pos_emb_189 apply_rotary_pos_emb
// cache_update 231 INLINE
#define ccs_intercept_cache_update_231 cache_update
// transpose_last_two_dims 246 INLINE
#define ccs_intercept_transpose_last_two_dims_246 transpose_last_two_dims
// GEMM_3D_float 266 INLINE
#define ccs_intercept_GEMM_3D_float_266 GEMM_3D_float
// create_causal_mask 286 INLINE
#define ccs_intercept_create_causal_mask_286 create_causal_mask
// softmax 298 INLINE
#define ccs_intercept_softmax_298 softmax
// attention 65 INLINE
