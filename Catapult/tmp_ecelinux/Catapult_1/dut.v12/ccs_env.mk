ifeq "$(CXX_HOME)" ""
CXX_HOME                                            := /opt/siemens/catapult/2024.1_2-1117371/Mgc_home/pkgs/dcs_gcc/usr
export CXX_HOME
endif
ifeq "$(CXX_TYPE)" ""
CXX_TYPE                                            := gcc
...
ifeq "$(QuestaSIM_Path)" ""
QuestaSIM_Path                                      := /opt/siemens/Questa/2024.2/questasim/bin
...
ifeq "$(MODEL_TECH)" ""
MODEL_TECH                                          := /opt/siemens/Questa/2024.2/questasim/bin
export MODEL_TECH
endif
ifeq "$(INCL_DIRS)" ""
INCL_DIRS                                           := 
