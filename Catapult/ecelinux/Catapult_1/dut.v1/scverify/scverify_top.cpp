...
public:
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 4253, 4253, 0)
    , catapult_monitor_INST("Monitor", clk, true, 4253LL, 4253LL)
...
void scverify_top::read_env() {
  ...
  unsigned long latency_est = 4251;
