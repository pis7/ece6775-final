...
PACKAGE dutmgc_rom_40_36864_8_1_60_pkg IS 
  COMPONENT dutmgc_rom_40_36864_8_1_60
    PORT (
      addr : IN STD_LOGIC_VECTOR(15 DOWNTO 0);
      data_out : OUT STD_LOGIC_VECTOR(7 DOWNTO 0)
    );
  END COMPONENT;
END dutmgc_rom_40_36864_8_1_60_pkg;

PACKAGE BODY dutmgc_rom_40_36864_8_1_60_pkg IS
END dutmgc_rom_40_36864_8_1_60_pkg;
...
USE mgc_hls.dutmgc_rom_40_36864_8_1_60_pkg.all;
LIBRARY std;
USE std.textio.all;
USE ieee.std_logic_textio.all;

ENTITY dutmgc_rom_40_36864_8_1_60 IS
    PORT (
      addr : IN STD_LOGIC_VECTOR(15 DOWNTO 0);
      data_out : OUT STD_LOGIC_VECTOR(7 DOWNTO 0)
    );
END dutmgc_rom_40_36864_8_1_60;

ARCHITECTURE v1 OF dutmgc_rom_40_36864_8_1_60 IS
  ...
  CONSTANT mem : lookup_table := lookup_table'(
    word'("00001010"),
    word'("00100010"),
    word'("01100101"),
    word'("00010010"),
